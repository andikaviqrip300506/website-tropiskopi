...
@section('content')
    ...
    {{-- <div class="page-inner bg-primary-gradient">
        <div class="row">
            <div class="col-sm-6 col-md-3">
                <a href="/admin/artikel" style="display: inline-block; text-decoration:none;">
            ...
            <div class="col-sm-6 col-md-3">
                <a href="/admin/slide" style="display: inline-block; text-decoration:none;">
                    <div class="card card-stats card-round d-block">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-5">
            ...
            <div class="col-sm-6 col-md-3">
                <a href="/admin/galeri" style="display: inline-block; text-decoration:none;">
                    <div class="card card-stats card-round d-block">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-5">
            ...
            <div class="col-sm-6 col-md-3">
                <a href="/admin/kontak" style="display: inline-block; text-decoration:none;">
                    <div class="card card-stats card-round d-block">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-5">
